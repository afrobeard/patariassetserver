"""
Django settings for patariassetserver project.
...
SECRET_KEY = 'h2wqlr1(tr(_%pt=w!2l4s!0!6!4f3!)_ri99=^1-=s#zj+hjd'
...
WSGI_APPLICATION = 'patariassetserver.wsgi.application'
